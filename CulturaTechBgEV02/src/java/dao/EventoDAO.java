...
public class EventoDAO {
    ...
    public List<Evento> consultarTodas(Connection conexion) throws SQLException {
        ...
        String sql = "SELECT e.id_evento, e.titulo, e.descripcion, e.fecha_hora, "
            + "e.costo, e.imagen, e.estado, e.id_categoria, e.id_lugar, "
            + "c.nombre_categoria, l.nombre_lugar, l.direccion, l.localidad "
            + "FROM evento e "
        ...
        try (PreparedStatement sentencia = conexion.prepareStatement(sql);
            ...
            while (resultado.next()) {
                ...
                evento.setNombreCategoria(resultado.getString("nombre_categoria"));
                evento.setNombreLugar(resultado.getString("nombre_lugar"));
                evento.setDireccion(resultado.getString("direccion"));
